...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href='<?php echo BASE_URL?>admincategory/categoryToggleTrash/<?php echo $c["catId"]?>' onclick='return confirm("ban co chac chan xoa sp nay?")'>Xóa</a>|<a href='<?php echo BASE_URL?>admincategory/updatecategory/<?php echo $c["catId"]?>'>Sửa</a></td>
    </tr>
<?php }?>
  </tbody>
</table>
