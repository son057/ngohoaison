...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href='<?php echo BASE_URL?>adminproduct/productDelete/<?php echo $p["productId"]?>' onclick='return confirm("ban co chac chan xoa vinh vien sp nay?")'>Xóa Vĩnh Viễn </a>|<a href='<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $p['productId']?> '>Khôi phục</a></td>
    </tr>
<?php }?>
  </tbody>
</table>
